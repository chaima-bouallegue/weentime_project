    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
            CommunicationUserPrincipal principal = new CommunicationUserPrincipal(
                    ...
                    jwtUtils.getEntrepriseIdFromJwtToken(jwt),
                    jwtUtils.getRolesFromJwtToken(jwt),
                    jwt
            );
            CommunicationAuthenticationToken authentication = new CommunicationAuthenticationToken(
                    principal,
                    jwt,
