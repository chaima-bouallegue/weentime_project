    ...
    await TestBed.configureTestingModule({
      imports: [
        ...
        LucideAngularModule.pick({
          ArrowRight, Briefcase, Check, Circle, CircleX,
          ExternalLink, Info, Loader2, MessageSquare, Mic,
          MicOff, Move, Play, RotateCcw, SendHorizontal,
          Shield, ShieldAlert, Sparkles, Square, Trash2,
