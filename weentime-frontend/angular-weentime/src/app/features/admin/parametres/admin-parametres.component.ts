  ...
  template: `
    <div class="placeholder-page">
      <div class="placeholder-card">
        <div class="placeholder-icon"><lucide-icon name="settings" size="40"></lucide-icon></div>
        <h1 class="placeholder-title">Paramètres</h1>
        <p class="placeholder-desc">Ce module est en cours de développement. Vous pourrez bientôt configurer les paramètres globaux de la plateforme ici.</p>
      </div>
    </div>
  `,
  styles: [`
