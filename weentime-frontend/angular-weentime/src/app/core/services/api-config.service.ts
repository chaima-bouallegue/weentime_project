...
export class ApiConfigService {
  ...
  readonly OVERTIME = {
    ...
    GET_RH_PENDING: `${this.API_BASE}/overtime/rh/pending`,
    MANAGER_DECISION: (id: number) => `${this.API_BASE}/overtime/${id}/manager-decision`,
    RH_DECISION: (id: number) => `${this.API_BASE}/overtime/${id}/rh-decision`,
